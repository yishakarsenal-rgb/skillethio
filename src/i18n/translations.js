...
export const translations = {
  ...
  copilotTag:         { en: 'Your bilingual coding mentor', am: 'ሁለት ቋንቋ የኮዲንግ አስተምህር' },
  copilotPlaceholder: {
  ...
  practiceSubtitle:   { en: 'Pick the best answer to earn XP', am: 'ለማሸነፍ ምርጥ መልሱን ይምረጡ' },
  ...
  // ── Premium Portal ─────────────────────────────────────────────────────────
  premiumTitle:       { en: 'Upgrade to SkillEthio Pro', am: 'ወደ SkillEthio Pro ይሻጉ' },
  premiumSubtitle:    {
  ...
  secureBadge:        { en: 'Secure · Local Payment Partners', am: 'ደህንነቱ የተጠበቀ · የአካባቢ ክፍያ አጋሮች' },

  // ── Footer ─────────────────────────────────────────────────────────────────
  footer: {
    en: '© 2026 SkillEthio · Built with ❤ in Addis Ababa by Yishak Mekuannent · በአዲስ አበባ የተሰራ',
    am: '© 2026 SkillEthio · በ Yishak Mekuannent በአዲስ አበባ የተሰራ',
  },
  builtBy: {
...
export const t = (key, lang) => translations[key]?.[lang] ?? translations[key]?.en ?? key;