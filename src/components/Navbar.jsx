...
/**
 * Top navigation: brand, bilingual toggle, theme toggle, gamified stat badges.
 */
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center gap-4">
        ...
        <div className="flex items-center gap-3 shrink-0">
          <div className="relative w-10 h-10 rounded-xl bg-gradient-to-br from-ethio-green to-ethio-gold shadow-iso-green flex items-center justify-center">
            <span className="font-display font-bold text-ethio-dark text-lg">SE</span>
        ...
        <div className="hidden md:flex items-center gap-2">
          <StatBadge icon="🔥" label={t('streak')} value={`${streak} ${t('days')}`} tone="gold" />
          <StatBadge icon="🏆" label={t('xp')} value={xp.toLocaleString()} tone="green" />
        ...
        <div
          className={[
            ...
            isDark ? 'border-ethio-green/30 bg-ethio-dark-2' : 'border-ethio-green/40 bg-white',
          ].join(' ')}
          role="group"
        ...
        >
          <span
            className={[
              ...
              isDark ? 'translate-x-6 bg-ethio-dark-2 text-ethio-gold' : 'translate-x-0 text-ethio-gold',
            ].join(' ')}
          >
            {isDark ? '🌙' : '☀️'}
          </span>
