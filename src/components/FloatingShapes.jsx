/**
 * FloatingShapes — animated background layer with isometric cubes, glowing
 * blobs and a soft grid. Pure CSS animations declared in index.css / tailwind.
