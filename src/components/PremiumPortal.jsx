...
/**
 * Premium Upgrade Portal — high-contrast CTA for Chapa / Telebirr payments,
...
const PremiumPortal = () => {
  ...
  const perks = [
    { en: 'Verified Certificate',          am: 'የተረጋገጠ ምስክር ወረቀት',        icon: '🎓' },
    { en: 'Offline Lessons (PDF + Video)', am: 'ከመስመር ውጭ ትምህርት (PDF + ቪዲዮ)', icon: '📚' },
    { en: '24/7 MiniMax AI Tutor',         am: '24/7 MiniMax AI አስተምህር',   icon: '🤖' },
    { en: 'Mock Interviews & Résumé Review', am: 'ሞክ ቃለ-መጠይቆች እና CV ግምገማ', icon: '💼' },
  ];
        ...
        <div className="relative">
          ...
          >
            <div className="flex items-baseline gap-2">
              <span className="font-display text-5xl font-bold gradient-text">299</span>
              <span className="text-sm opacity-70">ETB / month · በወር</span>
            </div>
            <div className="mt-1 text-xs opacity-70">
              ≈ $5.40 · Local pricing for Ethiopian students
            </div>

            <button
              type="button"
              className="btn-gold w-full mt-5 !py-3 text-sm"
              onClick={() => alert('Redirecting to Chapa / Telebirr checkout...')}
            >
              {t('premiumCta')}
            </button>
